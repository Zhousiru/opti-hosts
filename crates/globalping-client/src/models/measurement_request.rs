...
impl MeasurementRequest {
    pub fn new(r#type: models::MeasurementType, target: String) -> MeasurementRequest {
        MeasurementRequest {
            r#type,
            target,
            in_progress_updates: None,
            locations: None,
            limit: None,
