...
/// FinishedTracerouteTestResult : Represents a `finished` traceroute test.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FinishedTracerouteTestResult {
    #[serde(rename = "status")]
    ...
    #[serde(rename = "hops")]
    pub hops: Vec<models::FinishedTracerouteTestResultAllOfHops>,
}

impl FinishedTracerouteTestResult {
    /// Represents a `finished` traceroute test.
    pub fn new(status: models::FinishedTestStatus, raw_output: String, resolved_address: Option<String>, resolved_hostname: Option<String>, hops: Vec<models::FinishedTracerouteTestResultAllOfHops>) -> FinishedTracerouteTestResult {
