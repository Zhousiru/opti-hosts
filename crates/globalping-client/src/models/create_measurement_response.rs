...
/// CreateMeasurementResponse : Contains information about the newly created measurement.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateMeasurementResponse {
    /// The measurement ID. > **Tip**: You can use the ID to create a new measurement request, reusing the same probes. 
    #[serde(rename = "id")]
    pub id: String,
...
impl CreateMeasurementResponse {
    /// Contains information about the newly created measurement.
    pub fn new(id: String, probes_count: i32) -> CreateMeasurementResponse {
