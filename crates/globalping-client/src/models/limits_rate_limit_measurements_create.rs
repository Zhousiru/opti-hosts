...
pub struct LimitsRateLimitMeasurementsCreate {
...
impl LimitsRateLimitMeasurementsCreate {
    pub fn new(r#type: Type, limit: i32, remaining: i32, reset: i32) -> LimitsRateLimitMeasurementsCreate {
