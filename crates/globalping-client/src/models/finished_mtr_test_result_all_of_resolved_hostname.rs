...
pub struct FinishedMtrTestResultAllOfResolvedHostname {
}

impl FinishedMtrTestResultAllOfResolvedHostname {
    pub fn new() -> FinishedMtrTestResultAllOfResolvedHostname {
