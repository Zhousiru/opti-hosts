...
/// LimitsRateLimitMeasurements : Measurements rate limits.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LimitsRateLimitMeasurements {
    #[serde(rename = "create")]
    pub create: Box<models::LimitsRateLimitMeasurementsCreate>,
}

impl LimitsRateLimitMeasurements {
    /// Measurements rate limits.
    pub fn new(create: models::LimitsRateLimitMeasurementsCreate) -> LimitsRateLimitMeasurements {
        LimitsRateLimitMeasurements {
