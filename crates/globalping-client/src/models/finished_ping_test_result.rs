...
pub struct FinishedPingTestResult {
    #[serde(rename = "status")]
    ...
    pub timings: Vec<models::FinishedPingTestResultAllOfTimings>,
}

impl FinishedPingTestResult {
    /// Represents a `finished` ping test.
    pub fn new(status: models::FinishedTestStatus, raw_output: String, resolved_address: Option<String>, resolved_hostname: Option<String>, stats: models::FinishedPingTestResultAllOfStats, timings: Vec<models::FinishedPingTestResultAllOfTimings>) -> FinishedPingTestResult {
