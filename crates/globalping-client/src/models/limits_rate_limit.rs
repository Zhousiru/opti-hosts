...
/// LimitsRateLimit : Object containing rate limits information.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LimitsRateLimit {
    #[serde(rename = "measurements")]
    pub measurements: Box<models::LimitsRateLimitMeasurements>,
}

impl LimitsRateLimit {
    /// Object containing rate limits information.
    pub fn new(measurements: models::LimitsRateLimitMeasurements) -> LimitsRateLimit {
        LimitsRateLimit {
