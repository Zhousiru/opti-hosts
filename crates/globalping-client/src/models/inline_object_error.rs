...
/// InlineObjectError : Information about the error.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineObjectError {
...
impl InlineObjectError {
    /// Information about the error.
    pub fn new(r#type: String, message: String) -> InlineObjectError {
        InlineObjectError {
            r#type,
            message,
            params: None,
