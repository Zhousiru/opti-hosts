...
impl MeasurementResponse {
    pub fn new(id: String, r#type: models::MeasurementType, target: String, status: models::MeasurementStatus, created_at: String, updated_at: String, probes_count: i32, results: Vec<models::MeasurementResultItem>) -> MeasurementResponse {
        MeasurementResponse {
            id,
            r#type,
            target,
