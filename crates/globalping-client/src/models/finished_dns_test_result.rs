...
pub struct FinishedDnsTestResult {
    #[serde(rename = "status")]
    ...
    pub timings: Box<models::DnsTestHopResultTimings>,
    /// An array containing details about each hop.
    #[serde(rename = "hops")]
    pub hops: Vec<models::DnsTestHopResult>,
}

impl FinishedDnsTestResult {
    pub fn new(status: models::FinishedTestStatus, raw_output: String, status_code: i32, status_code_name: String, resolver: String, answers: Vec<models::DnsTestAnswer>, timings: models::DnsTestHopResultTimings, hops: Vec<models::DnsTestHopResult>) -> FinishedDnsTestResult {
