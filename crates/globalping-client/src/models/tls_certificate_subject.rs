...
/// TlsCertificateSubject : Information about the certificate subject.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TlsCertificateSubject {
...
impl TlsCertificateSubject {
    /// Information about the certificate subject.
    pub fn new() -> TlsCertificateSubject {
