...
impl DnsTestHopResult {
    pub fn new(resolver: String, answers: Vec<models::DnsTestAnswer>, timings: models::DnsTestHopResultTimings) -> DnsTestHopResult {
        DnsTestHopResult {
            resolver,
            answers,
