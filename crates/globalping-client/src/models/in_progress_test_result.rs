...
pub struct InProgressTestResult {
    #[serde(rename = "status")]
    pub status: Box<models::InProgressTestStatus>,
...
impl InProgressTestResult {
    /// Represents an `in-progress` test where most fields are not yet available. 
    pub fn new(status: models::InProgressTestStatus, raw_output: String) -> InProgressTestResult {
