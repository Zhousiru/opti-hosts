...
pub struct FinishedTracerouteTestResultAllOfTimings {
    /// The round-trip time for this packet.
    #[serde(rename = "rtt")]
    pub rtt: f64,
}

impl FinishedTracerouteTestResultAllOfTimings {
    pub fn new(rtt: f64) -> FinishedTracerouteTestResultAllOfTimings {
