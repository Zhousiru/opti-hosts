...
pub struct MeasurementResultItem {
    #[serde(rename = "probe")]
    pub probe: Box<models::MeasurementResultItemProbe>,
    #[serde(rename = "result")]
    pub result: Box<models::TestResult>,
}

impl MeasurementResultItem {
    pub fn new(probe: models::MeasurementResultItemProbe, result: models::TestResult) -> MeasurementResultItem {
