...
pub struct FinishedMtrTestResultAllOfResolvedAddress {
}

impl FinishedMtrTestResultAllOfResolvedAddress {
    pub fn new() -> FinishedMtrTestResultAllOfResolvedAddress {
