...
pub struct FinishedSimpleDnsTestResult {
    #[serde(rename = "status")]
...
impl FinishedSimpleDnsTestResult {
    /// Represents a `finished` DNS test with `trace` disabled.
    pub fn new(status: models::FinishedTestStatus, raw_output: String, resolver: String, answers: Vec<models::DnsTestAnswer>, timings: models::DnsTestHopResultTimings, status_code: i32, status_code_name: String) -> FinishedSimpleDnsTestResult {
