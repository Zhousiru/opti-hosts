...
pub struct FinishedTraceDnsTestResult {
    #[serde(rename = "status")]
...
impl FinishedTraceDnsTestResult {
    /// Represents a `finished` DNS test with `trace` enabled.
    pub fn new(status: models::FinishedTestStatus, raw_output: String, hops: Vec<models::DnsTestHopResult>) -> FinishedTraceDnsTestResult {
