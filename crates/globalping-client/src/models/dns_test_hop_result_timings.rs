...
/// DnsTestHopResultTimings : Details about the query times. All times are in milliseconds. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DnsTestHopResultTimings {
    /// The total query time.
    #[serde(rename = "total")]
    pub total: f64,
}

impl DnsTestHopResultTimings {
    /// Details about the query times. All times are in milliseconds. 
    pub fn new(total: f64) -> DnsTestHopResultTimings {
