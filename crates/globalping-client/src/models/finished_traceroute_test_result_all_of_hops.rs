...
pub struct FinishedTracerouteTestResultAllOfHops {
...
impl FinishedTracerouteTestResultAllOfHops {
    pub fn new(resolved_address: Option<String>, resolved_hostname: Option<String>, timings: Vec<models::FinishedTracerouteTestResultAllOfTimings>) -> FinishedTracerouteTestResultAllOfHops {
        FinishedTracerouteTestResultAllOfHops {
            resolved_address,
            resolved_hostname,
            timings,
        }
